% Template for DSLW 2021 paper; to be used with:
%          spconf.sty  - ICASSP/ICIP/ICME/DSLW LaTeX style file, and
...
% Title.
% ------
\title{AUTHOR GUIDELINES FOR DSLW 2021 PROCEEDINGS}
%
% Single address.
% ---------------
\name{Anonymous DSLW submission}
...
Papers should be no longer than \textbf{5 pages}, including all text and figures, \textbf{plus 1 page} of references. Supplemental material of up to 2 pages may also be submitted.
...
By submitting a manuscript to DSLW, the authors guarantee that it has not been previously published (or accepted for publication) in substantially similar form. Furthermore, no paper which contains significant overlap with the contributions of this paper either has been or will be submitted during the DSLW 2021 review period to either a journal or a conference.

If there are papers that may appear to violate any of these conditions, then it is the authors' responsibility to (1) cite these papers (preserving anonymity as described in Section 2 of this example paper), (2) argue in the body of your paper why your DSLW paper is nontrivially different from these concurrent submissions, and (3) include anonymized versions of those papers in the supplemental material.
...
Sometimes your paper is about a problem which you tested using a tool which is widely known to be restricted to a single institution.  For example, let's say it's 1969, you have solved a key problem on the Apollo lander, and you believe that the DSLW audience would like to hear about your solution.  The work is a development of your celebrated 1968 paper entitled ``Zero-g frobnication: How being the only people in the world with access to the Apollo lander source code makes us a wow at parties'', by Zeus.
