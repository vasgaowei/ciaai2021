...
const Instruction = ()=> (
    <div>
        ...
        <p>CICAI 2021 will not consider any paper that, at the time of submission, is under review for or has already been published or accepted for publication in any archival venue such as a journal or a conference. (Workshops and preprint servers such as arXiv are acceptable, as described in the paragraph above.) Authors are free to retract a submission from a venue with a concurrent review process (e.g., from NeurIPS or EMNLP) and submit the same work to CICAI 2021 as a regular paper provided that this retraction occurs before the CICAI 2021 submission. Authors must confirm at the time of submission that the paper is not under review at another archival conference or journal. </p>
        <p>Once they have made a submission to CICAI 2021, authors may not submit the same paper to another archival conference or journal until they receive an accept/reject decision from CICAI 2021 or they withdraw their submission from CICAI 2021. In some cases, it may require a judgement call to determine whether two concurrent submissions constitute a violation of CICAI 2021’s multiple submission policy. If a concern is raised about the similarity of two non-identical submissions, at least three people will inspect whatever information is available about both submissions. If they all agree that the simultaneous submission has excessive technical overlap, the paper will be summarily rejected and the organizers of the other conference will be informed about CICAI 2021’s decision. As with all summary rejects, such decisions are final. </p>
        
        <h2>Citation and Comparison</h2>
        <p>Papers are expected to cite those refereed publications most relevant to their content, but authors are excused for not knowing about all non-refereed work (e.g, appearing on ArXiv). Nevertheless, in cases where such prior work is widely known in the field, its existence may be considered by reviewers in assessing a submission’s novelty. Papers published less than two months before the regular paper submission deadline (April 18, 2021) are considered contemporaneous to all CICAI 2021 submissions (whether submitted as regular or fast track submissions); authors are not obliged to address such papers (though, especially for the camera ready versions of accepted papers, authors are encouraged to do so). </p>
        ...
        <h2>Ethics Policy</h2>
        <p>All CICAI 2021 authors and reviewers are required to honor the CICAI 2021 Publications Ethics and Malpractice Statement, as well as the CICAI 2021 Code of Professional Conduct. </p>
        <p>Additionally, this year, we encourage authors to (optionally) write a statement about the potential ethical impact of their work, including its broad societal implications, both positive and negative. This statement may be written within and as part of the two extra pages designated for references, and will not be counted in the seven pages of technical content. Although writing a statement is optional, reviewers will be asked to assess every paper’s ethical implications; a paper may be rejected for ethical reasons if (1) an author is found to violate the CICAI 2021 Publications Ethics and Malpractice Statement or the CICAI 2021 Code of Professional Conduct; or (2) reviewers identify negative ethical concerns about a paper and it did not adequately address these concerns either in an ethics statement or in its main body. </p>
        
        <h2>Conference Registration and Attendance</h2>
        <p>For each submitted paper, at least one author is required to register for the conference and to present the paper. Details about attendance at the conference will be posted to the CICAI 2021 web page. </p>

        <h2>Journal Track</h2>
        <p>A select set of top-rated papers may be nominated for fast track reviewing at participating journals. Nominated authors will be invited to submit extended versions of their CICAI 2021 papers for fast-track consideration. </p>
