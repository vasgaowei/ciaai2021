...
const Instruction = ()=> (
    <div>
        ...
        <p>Every submission requires a PDF manuscript. For regular papers, they must be submitted by May 1, 2021. There will be no individual exceptions.</p>
        <p>Submissions will not be accepted by e-mail or any other mechanism other than CMT. After submission, the system will not automatically send a confirmation of receipt. If you want to receive a confirmation email, please click the paper ID to view the submission, and then click the “Email” button at the top right to send the confirmation to yourself or all the authors. GAITC-YOFO2021 will contact authors again only if problems are encountered with papers.</p>
        <h2>Templates</h2>
        <p>Papers must be formatted in two-column, camera-ready style; see the GAITC-YOFO2021 author kit for details. Papers must be in trouble-free, high-resolution PDF format, formatted for US Letter (8.5″ x 11″) paper, using Type 1 or TrueType fonts. GAITC-YOFO2021 submissions are anonymous, and must conform to the instructions (detailed below) for double-blind review. The authors must manually remove all author and affiliation information from their submission for review, and may replace it with other information, such as paper number and keywords. Submissions may consist of up to 6 pages of technical content plus up to two additional pages solely for references, an ethics statement if applicable (see below); acknowledgements should be omitted from papers submitted for review, but may be included in these two additional pages for accepted papers.</p>
        ...
        <p>GAITC-YOFO2021 will not consider any paper that, at the time of submission, is under review for or has already been published or accepted for publication in any archival venue such as a journal or a conference. (Workshops and preprint servers such as arXiv are acceptable, as described in the paragraph above.) Authors are free to retract a submission from a venue with a concurrent review process (e.g., from NeurIPS or EMNLP) and submit the same work to GAITC-YOFO2021 as a regular paper provided that this retraction occurs before the GAITC-YOFO2021 submission. Authors must confirm at the time of submission that the paper is not under review at another archival conference or journal. </p>
        <p>Once they have made a submission to GAITC-YOFO2021, authors may not submit the same paper to another archival conference or journal until they receive an accept/reject decision from GAITC-YOFO2021 or they withdraw their submission from GAITC-YOFO2021. In some cases, it may require a judgement call to determine whether two concurrent submissions constitute a violation of GAITC-YOFO2021’s multiple submission policy. If a concern is raised about the similarity of two non-identical submissions, at least three people will inspect whatever information is available about both submissions. If they all agree that the simultaneous submission has excessive technical overlap, the paper will be summarily rejected and the organizers of the other conference will be informed about GAITC-YOFO2021’s decision. As with all summary rejects, such decisions are final. </p>
        
        <h2>Citation and Comparison</h2>
        <p>Papers are expected to cite those refereed publications most relevant to their content, but authors are excused for not knowing about all non-refereed work (e.g, appearing on ArXiv). Nevertheless, in cases where such prior work is widely known in the field, its existence may be considered by reviewers in assessing a submission’s novelty. Papers published less than two months before the regular paper submission deadline (September 9, 2020) are considered contemporaneous to all GAITC-YOFO2021 submissions (whether submitted as regular or fast track submissions); authors are not obliged to address such papers (though, especially for the camera ready versions of accepted papers, authors are encouraged to do so). </p>
        ...
        <h2>Ethics Policy</h2>
        <p>All GAITC-YOFO2021 authors and reviewers are required to honor the GAITC-YOFO2021Publications Ethics and Malpractice Statement, as well as the GAITC-YOFO2021 Code of Professional Conduct. </p>
        <p>Additionally, this year, we encourage authors to (optionally) write a statement about the potential ethical impact of their work, including its broad societal implications, both positive and negative. This statement may be written within and as part of the two extra pages designated for references, and will not be counted in the seven pages of technical content. Although writing a statement is optional, reviewers will be asked to assess every paper’s ethical implications; a paper may be rejected for ethical reasons if (1) an author is found to violate the GAITC-YOFO2021 Publications Ethics and Malpractice Statement or the GAITC-YOFO2021 Code of Professional Conduct; or (2) reviewers identify negative ethical concerns about a paper and it did not adequately address these concerns either in an ethics statement or in its main body. </p>
        
        <h2>Conference Registration and Attendance</h2>
        <p>For each submitted paper, at least one author is required to register for the conference and to present the paper. Details about attendance at the conference will be posted to the GAITC-YOFO2021 web page. </p>

        <h2>Journal Track</h2>
        <p>A select set of top-rated papers may be nominated for fast track reviewing at participating journals. Nominated authors will be invited to submit extended versions of their GAITC-YOFO2021 papers for fast-track consideration. </p>
