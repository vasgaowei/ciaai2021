...
const Submission = ()=> (
    <div>
        ...
        <p>Paper submission will be handled via the CMT system. Please submit your paper at <a href="https://cmt3.research.microsoft.com/" target="_blank">https://cmt3.research.microsoft.com/</a></p>
        ...
        <p>For the paper submission process, please see the <a href={process.env.PUBLIC_URL + '/CMT_instructions.pdf'} target="_blank">CMT instructions for authors</a> file for detail instructions on how to navigate the CMT submission site.</p>
